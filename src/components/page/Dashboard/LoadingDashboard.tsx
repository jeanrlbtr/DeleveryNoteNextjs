...
const LoadingDashboard = () => {
   ...
   return (
      <div className="flex relative">
         ...
         <div className="sticky top-0 left-0 h-screen pb-[40px] w-[60px] flex flex-col justify-between pt-[30px] bg-[#5C6EAA] rounded-r-[10px]"></div>
         <div className="h-screen overflow-auto flex flex-col">
            <div className="mb-[30px]">
               <p className="text-[30px] text-gray-500">Loading</p>
            </div>
            <div className="p-[20px] flex-1  mx-auto">
                        ...
                        <div className="w-full flex gap-[15px]">
                           {arr.map((data: any, index: number) => {
                              return (
                                 ...
                                 >
                                    <p
                                       className={`w-max font-[600]  text-[#818181]`}
                                    >
                                       ...
                                    </p>
               ...
               <div className="bg-white px-4 rounded-[8px] py-3 mt-[20px]">
                  <>
                     <div className="mt-[30px] px-[28px] flex justify-between items-center">
                        <p className="text-[26px] w-max text-[#525252]">
