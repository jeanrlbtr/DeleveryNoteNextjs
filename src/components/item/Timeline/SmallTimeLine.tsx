            ...
            <div className=" flex flex-col md:grid md:grid-cols-9 mx-auto p-2 ">
               <div className="flex flex-row-reverse md:contents">
                  <div className="w-full col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto border border-gray-300">
                     ...
                     <p className="text-gray-600">
                        ...
                        elit. Fugit blanditiis, dolore repellat dignissimos non
                        sint architecto vel provident temporibus dolor
                        cupiditate voluptatum ut doloribus nemo ipsa corporis
                        ad. Earum, labore.
                     </p>
                  </div>
                  ...
                  <div className="w-full col-start-6 col-end-10 flex items-center  ">
                     <h3 className="font-[400] text-[16px] mb-1 text-gray-600">
                        29 November 2023
                     </h3>
                  </div>
               </div>
               ...
               <div className="flex md:contents">
                  ...
                  <div className="w-full col-start-6 col-end-10 my-4 mr-auto p-4 border border-gray-300 rounded-xl">
                     ...
                     <p className="text-gray-600">
                        ...
                        Tempore nesciunt maiores ipsa molestiae magnam libero
                        dolorem explicabo. Nobis veniam incidunt at, alias ipsam
                        est suscipit maxime sunt quia. Consectetur, aut.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex flex-row-reverse md:contents">
                  <div className="w-full col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto border border-gray-300">
                     ...
                     <p className="text-gray-600">
                        Lorem ipsum, dolor sit amet consectetur adipisicing
                        elit. Nesciunt ratione perspiciatis consectetur? Impedit
                        inventore perferendis eligendi voluptatum facilis,
                        consequatur provident facere ab quasi laudantium magni
                        culpa porro tempora accusantium autem?
                     </p>
                  </div>
